...
export const globalTextData = {
  ...
  global: {
    en: {
      ...
      "error_api_limit_exceeded": "You have exceeded your API call limit for this period. Please try again later or consider upgrading your plan.",
      "error_model_not_allowed": "Your current tier does not permit using this model. The model has been switched to one available for your tier.",
      ...
      "aria_label_toggle_to_model": "Current model: {CURRENT_MODEL}\nSwitch to {TARGET_MODEL}",
      "tooltip_model_toggle_usage": "(Daily: {DAILY_COUNT}/{DAILY_LIMIT}, Hourly: {HOURLY_COUNT}/{HOURLY_LIMIT})\n{ARIA_LABEL}",
      "tooltip_model_toggle_anon_base": "Log in to use better AI models and save your progress.",
      "tooltip_model_toggle_usage_anon": "(Daily: {DAILY_COUNT}/{DAILY_LIMIT}, Hourly: {HOURLY_COUNT}/{HOURLY_LIMIT})\n{BASE_TEXT}",
      "system_model_switched": "System: AI Model switched to {MODEL_NAME}.",
      ...
      "modal_title_manage_subscription": "Manage Subscription & Tier",
      "tier_free_name": "Wanderer",
      "tier_pro_name": "Chronicler",
      "tier_ultra_name": "Architect",
      "feature_api_calls_flash": "Standard API Calls (Flash Model)",
      "feature_api_calls_pro": "Advanced API Calls (Pro Model)",
      "feature_api_calls_ultra": "Experimental API Calls (Ultra Model)",
      "feature_longer_responses": "Longer Context & Responses",
      "feature_priority_access": "Priority Access to New Features",
      "feature_world_shards": "World Fragments & Lore Persistence",
      "feature_unlimited": "Unlimited",
      "billing_monthly_suffix": "/ month",
      "billing_price_free": "Free",
      "billing_price_pro": "$10",
      "billing_price_ultra": "$20",
      "button_downgrade_plan": "Switch to Free",
      ...
      "alert_upgrade_failed_message": "Something went wrong during the upgrade process. Please try again or contact support if the issue persists.",
    ...
    cs: {
      ...
      "error_api_limit_exceeded": "Překročili jste svůj limit pro volání API pro toto období. Zkuste to prosím později nebo zvažte upgrade svého plánu.",
      "error_model_not_allowed": "Vaše aktuální úroveň neumožňuje použití tohoto modelu. Model byl přepnut na jiný, dostupný pro vaši úroveň.",
      ...
      "aria_label_toggle_to_model": "Aktuální model: {CURRENT_MODEL}\nPřepnout na {TARGET_MODEL}",
      "tooltip_model_toggle_usage": "(Denně: {DAILY_COUNT}/{DAILY_LIMIT}, Hodinově: {HOURLY_COUNT}/{HOURLY_LIMIT})\n{ARIA_LABEL}",
      "tooltip_model_toggle_anon_base": "Přihlaste se pro použití lepších AI modelů a uložení postupu.",
      "tooltip_model_toggle_usage_anon": "(Denně: {DAILY_COUNT}/{DAILY_LIMIT}, Hodinově: {HOURLY_COUNT}/{HOURLY_LIMIT})\n{BASE_TEXT}",
      "system_model_switched": "Systém: Model AI přepnut na {MODEL_NAME}.",
      "option_model_free": "Flash",
      "option_model_pro": "Pro",
      "option_model_ultra": "Ultra",
      ...
      // --- Billing & Subscriptions ---
      "modal_title_manage_subscription": "Spravovat Předplatné a Úroveň",
      "tier_free_name": "Poutník",
      "tier_pro_name": "Kronikář",
      "tier_ultra_name": "Architekt",
      "feature_api_calls_flash": "Standardní API Volání (Model Flash)",
      "feature_api_calls_pro": "Pokročilá API Volání (Model Pro)",
      "feature_api_calls_ultra": "Experimentální API Volání (Model Ultra)",
      "feature_longer_responses": "Delší Kontext a Odpovědi",
      "feature_priority_access": "Přednostní Přístup k Novým Funkcím",
      "feature_world_shards": "Fragmenty Světa a Perzistence Příběhu",
      ...
      "button_downgrade_plan": "Přepnout na Free",
      ...
      "button_upgrade_plan": "Upgradovat",
      "button_manage_plan": "Spravovat",
      "button_current_plan": "Aktuální Plán",
